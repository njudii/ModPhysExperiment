...
%答：由于是先测量液氮温度下的数据，刚一开始测量时闸流管内部并未达到热平衡，所以测量的数据会有较大误差。事实上，被删去的原第二数据点很有可能就是由于在这种未达到热平衡的情况下测量才产生如此之大的误差。反过来说，根据上述观点，图4-9 中的第二、三、四数据点也可以认为是坏点。并且，由于首次测量时最有可能未达到热平衡，所以第一数据点是坏点的可能性最大。
%--------bib------------------
%\newpage
\bibliography{ref}
\end{document}